            ...
            <div class="col-sm-12">
                <div class="card tab2-card">
                    <div class="card-header">
                        <h5> MODIFICATION DE LA PAGE {{ Str::upper($page->prenom) }}
                            {{ Str::upper($page->nom) }}</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="account" role="tabpanel"
                                ...
                                action="{{ route('page.update', $page->id) }}" method="POST"
                                enctype="multipart/form-data">
                                    ...
                                    <form class="needs-validation user-add" novalidate=""
                                    action="{{ route('page.update',$page->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <h4>{{__('PAGE') }} </h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <textarea  id="contenu"  name="contenu" class="form-control">{{$page->contenu}}</textarea>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <img src="{{asset('uploads/Page/'.$page->image)}}" alt="" width="700" >
                                        </div>
                                        <div class="col-xl-3 col-md-4">
