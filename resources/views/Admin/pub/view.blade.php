                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="account" role="tabpanel"
                                ...
                                <form class="needs-validation user-add" enctype="multipart/form-data">
                                    ...
                                    <h4>{{ Str::upper($pub->nom) }} DETAILS</h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            ...
                                            name="position" value="{{$pub->position}}" >
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <select name="pade_id" id="pade_id" class="form-select" >
                                                <option value="{{$pageOne->id}}">{{$pageOne->nom}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                          <img src="{{asset('uploads/Pubs/'.$pub->image)}}" alt="" width="200" >
                                        </div>
