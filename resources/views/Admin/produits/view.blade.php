            ...
            <div class="col-sm-12">
                <div class="card tab2-card">
                    <div class="card-header">
                        <h5> produit : {{ Str::upper($produit->nomProduit) }} </h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="account" role="tabpanel"
                                ...
                                <form class="needs-validation user-add" enctype="multipart/form-data">
                                    ...
                                    <h4>{{ Str::upper($produit->nomproduit) }} DETAILS</h4>
                                    <div class="form-group row">
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control " id="nomProduits" type="hidden" required=""
                                                name="user_id" value="{{ $produit->id }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control " id="nomProduit" type="text" required=""
                                                name="nomProduit" value="{{ $produit->id }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control " id="quantite" type="number" required=""
                                                name="quantite" value="{{ $produit->qte }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control " id="quantite" type="number" required=""
                                                name="seuil" value="{{ $produit->seuil }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <textarea name="description" id="description" cols="10" rows="5" class="form-control"> {{ $produit->Description }} </textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-4">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <img src="{{ asset('uploads/Produit/' . $produit->image) }}" alt=""
                                                width="500">
                                        </div>
