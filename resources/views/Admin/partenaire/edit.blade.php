            ...
            <div class="col-sm-12">
                <div class="card tab2-card">
                    <div class="card-header">
                        <h5> MODIFICATION DE LA partenaire {{ Str::upper($partenaire->prenom) }}
                            {{ Str::upper($partenaire->nom) }}</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="account" role="tabpanel"
                                ...
                                <form class="needs-validation user-add" novalidate=""
                                    action="{{ route('partenaire.update', $partenaire->id) }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control " id="nomProduit" type="text"
                                                name="nomPartenaire" value="{{$partenaire->nom}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-4">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <img src="{{ asset('uploads/Partenaire/' . $partenaire->image) }}"
