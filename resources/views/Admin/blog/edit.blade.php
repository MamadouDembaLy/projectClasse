                                ...
                                <form class="needs-validation user-add" novalidate=""
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control " id="titreBlog" type="text"
                                                name="titreBlog" value="{{$blog->titre}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-4">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control " id="detailBlog" type="text"
                                                name="detailBlog" value="{{$blog->detail}}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-xl-3 col-md-4">
