            ...
            <div class="chat-box">
                <div class="people-list friend-list">
                    <ul class="list">
                        ...
                        <li class="clearfix"><img class="rounded-circle user-image"
                                src="{{asset('assets//images/dashboard/user1.jpg')}}" alt="">
                        ...
                        <li class="clearfix"><img class="rounded-circle user-image"
                                src="{{asset('assets/images/dashboard/user2.jpg')}}" alt="">
                            <div class="status-circle online"></div>
                            <div class="about">
                        ...
                        <li class="clearfix"><img class="rounded-circle user-image"
                                src="{{asset('assets/images/dashboard/user3.jpg')}}" alt="">
                            <div class="status-circle online"></div>
                            <div class="about">
                        ...
                        <li class="clearfix"><img class="rounded-circle user-image"
                                src="{{asset('assets/images/dashboard/user5.jpg')}}" alt="">
                            <div class="status-circle away"></div>
                            <div class="about">
                        ...
                        <li class="clearfix"><img class="rounded-circle user-image"
                                src="{{asset('assets/images/dashboard/designer.jpg')}}" alt="">
                            <div class="status-circle online"></div>
                            <div class="about">
