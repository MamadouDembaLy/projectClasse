        ...
        <div class="col-sm-12">
            <div class="card tab2-card">
                <div class="card-header">
                    <h5> MODIFICATION DU FOURNISSEUR  {{Str::upper($fournisseur->prenom) }} {{Str::upper($fournisseur->nom) }}</h5>
                </div>
                <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade active show" id="account" role="tabpanel"
                            ...
                            <form class="needs-validation user-add" novalidate="" action="{{route('fournisseur.update',$fournisseur->id)}}"  method="POST" enctype="multipart/form-data" >
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-8 col-md-7">
                                        <input class="form-control " id="validationCustom4" type="text"
                                            required="" name="specialite" value="{{$fournisseur->specialite}}" >
                                    </div>
                                </div>
