...
<g>
	...
	<path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                    ...
                    <div class="card tab2-card">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true"><span class="icon-unlock me-2 "></span>Inscription</a>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form class="form-horizontal auth-form" method="POST" action="{{ route('admin.register') }}" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required="" name="name" :value="old('name')" type="text" class="form-control" placeholder="Nom"  id="name"">
                                            <x-input-error :messages="$errors->get('name')" class="mt-2" />
                                        </div>
                                        <!--email-->
                                        <div class="form-group">
                                            
                                            <input required="" name="email" :value="old('email')" type="email" class="form-control" placeholder="Email" id="email">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required="" name="password" type="password" class="form-control" placeholder="Password" id="password" equired autocomplete="new-password" >
                                            <x-input-error :messages="$errors->get('password')" class="mt-2" />
                                        </div>
                                        <div class="form-group">
                                           
                                            <input required="" name="password_confirmation" type="password" class="form-control" placeholder="Confirmer Password" id="password_confirmation" >
            ...
            <a href="{{route('admin.login')}}" class="btn btn-primary back-btn"><i data-feather="arrow-left"></i>Retour</a>
        </div>
    </div>
</div>
