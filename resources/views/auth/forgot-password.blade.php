...
<g>
	...
	<path style="fill:#808080;" d="M393.695,417.909l8.485-20.662l25.251,25.251c1.464,1.464,3.387,2.199,5.303,2.192
		c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                    ...
                    <div class="card tab2-card">
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab" href="#top-profile" role="tab" aria-controls="top-profile" aria-selected="true"><span class="icon-user me-2"></span>Oublie Password</a>
                                </li>
                            ...
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    ...
                                    <form method="POST" action="{{ route('admin.password.email') }}" class="form-horizontal auth-form">
                                        @csrf
                                        
                                        <div class="form-group">
                                            <x-input-label for="password" :value="__('email')" />
                                            <input required="" name="email" type="email" class="form-control" placeholder="Username" id="email" :value="old('email')">
            ...
            <a href="#" class="btn btn-primary back-btn"><i data-feather="arrow-left"></i>Retour</a>
        </div>
    </div>
</div>
