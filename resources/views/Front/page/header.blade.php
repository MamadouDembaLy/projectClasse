              ...
              <div class="nav-left" >
                ...
                <div class="collapse  nav-desk" id="navbarToggleExternalContent">
                  <ul class="nav-cat title-font">
                    ...
                    <li> <a href="category-page(left-sidebar).html"><img src="{{asset('assets/images/layout-1/nav-img/06.png')}}" alt="category-product"> Beauty, Health Products</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{asset('assets/images/layout-1/nav-img/07.png')}}" alt="category-product"> Grocery Products </a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{asset('assets/images/layout-1/nav-img/08.png')}}" alt="category-product"> Sports</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{asset('assets/images/layout-1/nav-img/09.png')}}" alt="category-product"> Bags, Luggage</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{asset('assets/images/layout-1/nav-img/10.png')}}" alt="category-product"> Movies, Music </a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{asset('assets/images/layout-1/nav-img/11.png')}}" alt="category-product"> Video Games</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{asset('assets/images/layout-1/nav-img/12.png')}}" alt="category-product"> Toys, Baby Products</a></li>
                    <li>
                        ...
                        <div class="container">
                          <div class="row">
                            ...
                            <div class="col mega-box product ">
                              <div class="mega-img">
                                <img src="{{asset('assets/images/mega-banner.jpg')}}" alt="menu-banner" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div class="category-right">
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu gift-dropdown">
                  ...
                  <div class="media">
                    <div  class="me-3">
                      <img src="{{asset('assets/images/icon/2.png')}}" alt="Generic placeholder image" class="gift-bloc">
                    </div>
                    <div class="media-body">
                      <h5 class="mt-0">Fashion Discount</h5>
                      <p><img src="{{asset('assets/images/icon/fire.png')}}"  class="fire" alt="fire">Extra 10% off (upto Rs. 10,000*) </p>
                    </div>
                  </div>
                  <div class="media">
                    <div  class="me-3">
