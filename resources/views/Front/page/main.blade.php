                            ...
                            <div class="slider-banner p-center slide-banner-1">
                                <div class="slider-img">
                                    <ul class="layout1-slide-1">
                                        <li id="img-1"><img src="{{ asset('uploads/Slide/'. $slide->image) }}"
                                                alt="slider"></li>
                                ...
                                <div class="slider-banner-contain">
                                    <div>
                                        <h1><span>{{$slide->message1}}</span></h1>
                                ...
                                <div class="slider-img">
                                    <ul class="layout1-slide-2">
                                        <li id="img-3" class="slide-center"><img
                                                src="{{ asset('assets/images/layout-2/slider/2.1.png') }}" class="img-fluid"
                                                alt="slider"></li>
                                        <li id="img-4" class="slide-center"><img
                                                src="{{ asset('assets/images/layout-2/slider/2.2.png') }}" class="img-fluid"
                                                alt="slider"></li>
                                    </ul>
                                </div>
                                <div class="slider-banner-contain">
                            ...
                            <div class="slider-banner p-center slide-banner-1">
                                <div class="slider-img">
                                    <ul class="layout1-slide-3">
                                        <li id="img-5"><img src="{{ asset('assets/images/layout-2/slider/3.2.png') }}"
                                                class="img-fluid" alt="slider"></li>
                                        <li id="img-6" class="slide-center"><img
                                                src="{{ asset('assets/images/layout-2/slider/3.1.png') }}" class="img-fluid"
                                                alt="slider"></li>
                                    </ul>
                                </div>
                                <div class="slider-banner-contain">
        ...
        <div class="custom-container">
            <div class="row collection2">
                <div class="col-md-4">
                    <div class="collection-banner-main banner-1  p-right">
                        <div class="collection-img">
                            <img src="{{ asset('assets/images/layout-2/collection-banner/1.jpg') }}')}}"
                ...
                <div class="col-md-4">
                    <div class="collection-banner-main banner-1 p-right">
                        <div class="collection-img">
                            <img src="{{ asset('assets/images/layout-2/collection-banner/2.jpg') }}"
                                class="img-fluid bg-img  " alt="banner">
                        </div>
                        <div class="collection-banner-contain ">
                            <div>
                ...
                <div class="col-md-4">
                    <div class="collection-banner-main banner-1 p-right">
                        <div class="collection-img">
                            <img src="{{ asset('assets/images/layout-2/collection-banner/3.jpg') }}"
                                class="img-fluid bg-img  " alt="banner">
                        </div>
                        <div class="collection-banner-contain ">
                            <div>
            ...
            <div class="row">
                <div class="col">
                    <div class="collection-banner-main banner-5 p-center">
                        <div class="collection-img">
                            <img src="{{ asset('assets/images/layout-2/collection-banner/7.jpg') }}" class="bg-img  "
                                alt="banner">
                        </div>
                        <div class="collection-banner-contain ">
                    ...
                    <div class="slide-6 no-arrow">
                            ...
                            <div class="category-contain">
                                <div class="img-wrapper">
                                    <a href="category-page(left-sidebar).html">
                                        <img src="{{ asset('assets/images/layout-1/rounded-cat/1.png') }}"
                        ...
                        <div>
                            <div class="category-contain">
                                <div class="img-wrapper">
                                    <a href="category-page(left-sidebar).html">
                                        <img src="{{ asset('assets/images/layout-1/rounded-cat/2.png') }}"
                                            alt="category  " class="img-fluid">
                                    </a>
                                </div>
                                <a href="category-page(left-sidebar).html" class="btn-rounded">
                        ...
                        <div>
                            <div class="category-contain">
                                <div class="img-wrapper">
                                    <a href="category-page(left-sidebar).html">
                                        <img src="{{ asset('assets/images/layout-1/rounded-cat/3.png') }}"
                                            alt="category  " class="img-fluid">
                                    </a>
                                </div>
                                <a href="category-page(left-sidebar).html" class="btn-rounded">
                        ...
                        <div>
                            <div class="category-contain">
                                <div class="img-wrapper">
                                    <a href="category-page(left-sidebar).html">
                                        <img src="{{ asset('assets/images/layout-1/rounded-cat/4.png') }}"
                                            alt="category  " class="img-fluid">
                                    </a>
                                </div>
                                <a href="category-page(left-sidebar).html" class="btn-rounded">
                        ...
                        <div>
                            <div class="category-contain">
                                <div class="img-wrapper">
                                    <a href="category-page(left-sidebar).html">
                                        <img src="{{ asset('assets/images/layout-1/rounded-cat/5.png') }}"
                                            alt="category  " class="img-fluid">
                                    </a>
                                </div>
                                <a href="category-page(left-sidebar).html" class="btn-rounded">
                        ...
                        <div>
                            <div class="category-contain">
                                <div class="img-wrapper">
                                    <a href="category-page(left-sidebar).html">
                                        <img src="{{ asset('assets/images/layout-1/rounded-cat/6.png') }}"
                                            alt="category  " class="img-fluid">
                                    </a>
                                </div>
                                <a href="category-page(left-sidebar).html" class="btn-rounded">
                        ...
                        <div>
                            <div class="category-contain">
                                <div class="img-wrapper">
                                    <a href="category-page(left-sidebar).html">
                                        <img src="{{ asset('assets/images/layout-1/rounded-cat/7.png') }}"
                                            alt="category  " class="img-fluid">
                                    </a>
                                </div>
                                <a href="category-page(left-sidebar).html" class="btn-rounded">
                                    ...
                                    <div>
                                        <div class="media-banner media-banner-1 border-0">
                                            <div class="media-banner-box">
                                                <div class="media">
                                                    <a href="product-page(left-sidebar).html">
                                                        <img src="{{ asset('assets/images/layout-2/media-banner/1.jpg') }}"
                                            ...
                                            <div class="media-banner-box">
                                                <div class="media">
                                                    <a href="product-page(left-sidebar).html">
                                                        <img src="{{ asset('assets/images/layout-2/media-banner/2.jpg') }}"
                                                            class="img-fluid " alt="banner">
                                                    </a>
                                                    <div class="media-body">
                                                        <div class="media-contant">
                                            ...
                                            <div class="media-banner-box">
                                                <div class="media">
                                                    <a href="product-page(left-sidebar).html">
                                                        <img src="{{ asset('assets/images/layout-2/media-banner/3.jpg') }}"
                                                            class="img-fluid " alt="banner">
                                                    </a>
                                                    <div class="media-body">
                                                        <div class="media-contant">
            ...
            <div class="row collection2">
                <div class="col-md-4">
                    <div class="collection-banner-main banner-1 p-left">
                        <div class="collection-img">
                            <img src="{{ asset('assets/images/layout-2/collection-banner/4.jpg') }}"
                                class="img-fluid bg-img " alt="banner">
                        </div>
                        <div class="collection-banner-contain ">
                            <div>
                ...
                <div class="col-md-4">
                    <div class="collection-banner-main banner-1 p-left">
                        <div class="collection-img">
                            <img src="{{ asset('assets/images/layout-2/collection-banner/5.jpg') }}"
                                class="img-fluid bg-img " alt="banner">
                        </div>
                        <div class="collection-banner-contain ">
                            <div>
                ...
                <div class="col-md-4">
                    <div class="collection-banner-main banner-1 p-left">
                        <div class="collection-img">
                            <img src="{{ asset('assets/images/layout-2/collection-banner/6.jpg') }}"
                                class="img-fluid bg-img " alt="banner">
                        </div>
                        <div class="collection-banner-contain ">
                            <div>
                                ...
                                <div class="row hot-deal-subcontain hotdeal-block1">
                                        ...
                                        <div class="hotdeal-right-slick border-0">
                                            <a href="product-page(left-sidebar).html">
                                                <div class="img-wrraper">
                                                    <div>
                                                        <img src="{{ asset('assets/images/layout-2/hot-deal/8.jpg') }}"
                                            ...
                                            <a href="product-page(left-sidebar).html">
                                                <div class="img-wrraper">
                                                    <div>
                                                        <img src="{{ asset('assets/images/layout-2/hot-deal/7.jpg') }}"
                                                            alt="hot-deal" class="img-fluid  bg-img">
                                                    </div>
                                                </div>
                                            </a>
                                            <a href="product-page(left-sidebar).html">
                                                <div class="img-wrraper">
                                                    <div>
                                                        <img src="{{ asset('assets/images/layout-2/hot-deal/6.jpg') }}"
                                                            alt="hot-deal" class="img-fluid  bg-img">
                                                    </div>
                                                </div>
                                            </a>
                                            <a href="product-page(left-sidebar).html">
                                                <div class="img-wrraper">
                                                    <div>
                                                        <img src="{{ asset('assets/images/layout-2/hot-deal/5.jpg') }}"
                                                            alt="hot-deal" class="img-fluid  bg-img">
                                                    </div>
                                                </div>
                                            </a>
                                    ...
                                    <div class="col-md-2 ">
                                        <div class="hotdeal-right-nav">
                                            <div><img src="{{ asset('assets/images/layout-2/hot-deal/8.jpg') }}"
                                                    alt="hot-dea" class="img-fluid  "></div>
                                            <div><img src="{{ asset('assets/images/layout-2/hot-deal/7.jpg') }}"
                                                    alt="hot-dea" class="img-fluid  "></div>
                                            <div><img src="{{ asset('assets/images/layout-2/hot-deal/6.jpg') }}"
                                                    alt="hot-dea" class="img-fluid  "></div>
                                            <div><img src="{{ asset('assets/images/layout-2/hot-deal/5.jpg') }}"
                                                    alt="hot-dea" class="img-fluid  "></div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="slide-1 no-arrow">
                            ...
                            <div class="testimonial-contain">
                                <div class="media">
                                    <div class="testimonial-img">
                                        <img src="{{ asset('assets/images/testimonial/1.jpg') }}"
                        ...
                        <div>
                            <div class="testimonial-contain">
                                <div class="media">
                                    <div class="testimonial-img">
                                        <img src="{{ asset('assets/images/testimonial/3.jpg') }}"
                                            class="img-fluid rounded-circle  " alt="testimonial">
                                    </div>
                                    <div class="media-body">
                                        <h5>mark jecno</h5>
                        ...
                        <div>
                            <div class="product-box">
                                <div class="product-imgbox">
                                    <div class="product-front">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="{{ asset('assets/images/layout-2/product/2.jpg') }}"
                                                class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-back">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="{{ asset('assets/images/layout-2/product/a2.jpg') }}"
                                                class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-icon icon-inline">
                        ...
                        <div class="slide-7 no-arrow">
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('assets/images/insta/1.jpg') }}" class="img-fluid  "
                                        alt="insta">
                            ...
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('assets/images/insta/2.jpg') }}" class="img-fluid  "
                                        alt="insta">
                                    <div class="insta-cover">
                                        <i class="fa fa-instagram"></i>
                                    </div>
                            ...
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('assets/images/insta/3.jpg') }}" class="img-fluid  "
                                        alt="insta">
                                    <div class="insta-cover">
                                        <i class="fa fa-instagram"></i>
                                    </div>
                            ...
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('assets/images/insta/4.jpg') }}" class="img-fluid  "
                                        alt="insta">
                                    <div class="insta-cover">
                                        <i class="fa fa-instagram"></i>
                                    </div>
                            ...
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('assets/images/insta/5.jpg') }}" class="img-fluid  "
                                        alt="insta">
                                    <div class="insta-cover">
                                        <i class="fa fa-instagram"></i>
                                    </div>
                            ...
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('assets/images/insta/6.jpg') }}" class="img-fluid  "
                                        alt="insta">
                                    <div class="insta-cover">
                                        <i class="fa fa-instagram"></i>
                                    </div>
                            ...
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('assets/images/insta/7.jpg') }}" class="img-fluid  "
                                        alt="insta">
                                    <div class="insta-cover">
                                        <i class="fa fa-instagram"></i>
                                    </div>
                            ...
                            <div>
                                <div class="instagram-box">
                                    <img src="{{ asset('assets/images/insta/8.jpg') }}" class="img-fluid  "
                                        alt="insta">
                                    <div class="insta-cover">
                                        <i class="fa fa-instagram"></i>
                                    </div>
